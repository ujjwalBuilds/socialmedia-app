              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    ...
                    const TextSpan(text: 'All content included in or made available through the Services is the exclusive property of BondBridge or its content suppliers and is protected by applicable intellectual property laws. All rights not expressly granted are reserved and retained by BondBridge or its licensors.\n\n'),
                    _buildHeading('Software'),
                    const TextSpan(text: 'Any software available through the Services is copyrighted by BondBridge and/or its suppliers. Use of the Software is governed by the end user license agreement. Unauthorized reproduction or redistribution is prohibited by law and may result in legal penalties.\n\n'),
                    _buildHeading('Restricted Rights Legend'),
                    const TextSpan(text: 'Software downloaded for or on behalf of the U.S. Government is provided with Restricted Rights as defined in applicable federal regulations. Manufacturer is BondBridge Corporation, One BondBridge Way, Redmond, WA 98052-6399.\n\n'),
                    ...
                    const TextSpan(text: 'Software and tools are provided "as is" without warranties except as specified in the license agreement. BondBridge disclaims all other warranties including merchantability and fitness for a particular purpose.\n\n'),
                    _buildHeading('Limitation of Liability'),
                    const TextSpan(text: 'BondBridge is not liable for any damages resulting from the use or inability to use the Services, including software, documents, or data.\n\n'),
                    ...
                    const TextSpan(text: 'AI Services may not be reverse engineered or used for scraping or training other AI systems. BondBridge monitors inputs and outputs to prevent abuse. Users are responsible for legal compliance and third-party claims related to AI use.\n\n'),
                    _buildHeading('Materials Provided to BondBridge'),
                    const TextSpan(text: 'By submitting content, you grant BondBridge the rights to use it in connection with its Services. No compensation is provided. You must own or have permission to share submitted content, including images.\n\n'),
                    ...
                    const TextSpan(text: 'Linked third-party websites are not under BondBridge\'s control. BondBridge is not responsible for their content or transmissions. Links are provided for convenience, not endorsement.\n\n'),
                    _buildHeading('Unsolicited Idea Submission Policy'),
                    const TextSpan(text: 'BondBridge does not accept unsolicited ideas. If submitted, such materials are not treated as confidential or proprietary. This policy prevents disputes over similar ideas developed by BondBridge.\n\n\n\n'),
