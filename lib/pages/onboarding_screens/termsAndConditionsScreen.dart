              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    ...
                    const TextSpan(text: 'The services that ancoway provides to all users are subject to the following Terms of Use ("TOU"). ancoway reserves the right to update and modify the TOU at any time without notice. The most current version of the TOU can be reviewed by clicking on the "Terms of Use" hypertext link located at the bottom of our Web pages. When we make updates to the TOU, ancoway will update the date at the top of this page. By using the website after a new version of the TOU has been posted, you agree to the terms of such new version.\n\n'),
                    _buildHeading('Description of Services'),
                    const TextSpan(text: 'Through its network of Web properties, ancoway provides you with access to a variety of resources, including applications, download areas, communication forums and product information (collectively "Services"). The Services, including any updates, enhancements, new features, and/or the addition of any new Web properties, are subject to this TOU.\n\n'),
                    ...
                    const TextSpan(text: 'All content included in or made available through the Services is the exclusive property of ancoway or its content suppliers and is protected by applicable intellectual property laws. All rights not expressly granted are reserved and retained by ancoway or its licensors.\n\n'),
                    _buildHeading('Software'),
                    const TextSpan(text: 'Any software available through the Services is copyrighted by ancoway and/or its suppliers. Use of the Software is governed by the end user license agreement. Unauthorized reproduction or redistribution is prohibited by law and may result in legal penalties.\n\n'),
                    _buildHeading('Restricted Rights Legend'),
                    const TextSpan(text: 'Software downloaded for or on behalf of the U.S. Government is provided with Restricted Rights as defined in applicable federal regulations. Manufacturer is ancoway Corporation, One ancoway Way, Redmond, WA 98052-6399.\n\n'),
                    ...
                    const TextSpan(text: 'Software and tools are provided "as is" without warranties except as specified in the license agreement. ancoway disclaims all other warranties including merchantability and fitness for a particular purpose.\n\n'),
                    _buildHeading('Limitation of Liability'),
                    const TextSpan(text: 'ancoway is not liable for any damages resulting from the use or inability to use the Services, including software, documents, or data.\n\n'),
                    ...
                    const TextSpan(text: 'No harassment or privacy violations\nNo posting inappropriate or unlawful content\nNo distribution of protected content without rights\nNo uploading of harmful software\nNo unauthorized advertising\nNo downloading of content that cannot be legally shared\nNo deletion of copyright or source information\nNo obstruction of others\' use of services\nNo identity falsification\nNo unlawful activity or violations of conduct codes\nancoway may remove content or suspend access at its discretion and is not responsible for content shared by users. Use caution when sharing personal information.\n\n'),
                    _buildHeading('AI Services'),
                    const TextSpan(text: 'AI Services may not be reverse engineered or used for scraping or training other AI systems. ancoway monitors inputs and outputs to prevent abuse. Users are responsible for legal compliance and third-party claims related to AI use.\n\n'),
                    _buildHeading('Materials Provided to ancoway'),
                    const TextSpan(text: 'By submitting content, you grant ancoway the rights to use it in connection with its Services. No compensation is provided. You must own or have permission to share submitted content, including images.\n\n'),
                    ...
                    const TextSpan(text: 'Linked third-party websites are not under ancoway\'s control. ancoway is not responsible for their content or transmissions. Links are provided for convenience, not endorsement.\n\n'),
                    _buildHeading('Unsolicited Idea Submission Policy'),
                    const TextSpan(text: 'ancoway does not accept unsolicited ideas. If submitted, such materials are not treated as confidential or proprietary. This policy prevents disputes over similar ideas developed by ancoway.\n\n\n\n'),
